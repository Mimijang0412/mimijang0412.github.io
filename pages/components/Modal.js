...
const Modal = ({ content, targetModalId, modalId, handleClick, handleClose, showProp, children }) => {
	return (
		<div
      id={`modal-${modalId}`}
			className={`${
		...
		>
			<div className='modal-main fixed z-[2000] bg-black w-full h-[100vh] top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2'>
				<div className='relative w-full h-full flex justify-center items-center flex-col sm:flex-row'>
					<h1 className='absolute top-[50px] text-lg md:text-2xl text-center text-white font-bolded'>{ content && content.name}</h1>
					<button
						type='button'
						onClick={handleClose}
						className='absolute top-[30px] right-[40px] text-4xl lowercase text-white hover:opacity-80'
					>
						x
					</button>
          {/* laptop */}
          <div className='sm:-mr-[50px] lg:mr-0'>
                ...
                layout='fill'
							...
							<div className='absolute left-[50px] sm:left-[80px] lg:left-[145px] top-[30px] sm:top-[45px] lg:top-[80px] max-h-[155px] sm:max-h-[235px] lg:max-h-[425px] overflow-scroll'>
								<div className='relative w-[235px] h-[300px] sm:w-[380px] lg:w-[692px] sm:h-[550px] lg:h-[800px]'>
                <Image
          ...
          {/* phone */}
                ...
                layout='fill'
							...
							<div className='absolute left-[35px] lg:left-[70px] top-[5px] lg:top-[10px] max-h-[275px] lg:max-h-[550px] overflow-scroll rounded-2xl lg:rounded-[27px]'>
								<div className='relative w-[130px] h-[500px] lg:w-[260px] lg:h-[1000px]'>
                <Image
