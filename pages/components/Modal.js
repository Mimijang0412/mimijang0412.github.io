...
const Modal = ({ content, targetModalId, modalId, handleClose, showProp }) => {
	return (
		<div
			id={`modal-${modalId}`}
			className={`${
			...
			{ content &&(
				<div className='modal-main fixed z-[9990] bg-white dark:bg-black w-full h-[100vh] top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2'>
					<div className='relative w-full h-full flex justify-center items-center flex-col sm:flex-row'>
						<h1 className='max-w-[80%] mx-auto absolute top-[20px] sm:top-[50px] text-lg leading-5 md:text-2xl text-center text-white font-bolded'>
							{ content.name}
						</h1>
						<button
							type='button'
						...
						<div className='sm:-mr-[50px] lg:mr-0 pb-[20px]'>
							<div className='relative w-[340px] h-[220px] sm:w-[550px] sm:h-[330px] lg:w-[1000px] lg:h-[600px]'>
								...
								<div className='absolute left-[50px] sm:left-[80px] lg:left-[145px] top-[30px] sm:top-[45px] lg:top-[80px] max-h-[155px] sm:max-h-[235px] lg:max-h-[425px] overflow-scroll'>
									<div
										className={`relative w-[235px] h-[${
											 content.desktopImgHeight
										}px] sm:w-[380px] lg:w-[692px] sm:h-[${
											
											content.desktopImgHeightSm
										}px] lg:h-[${
											
											content.desktopImgHeightLg
										}px]  min-h-[155px] sm:min-h-[235px] lg:min-h-[425px]`}
									>
										<Image
						...
						<div className='sm:-ml-[100px] sm:mt-[100px] lg:-ml-[350px] lg:mt-[100px]'>
							<div className='mobile-phone-img relative w-[200px] h-[300px] lg:w-[400px] lg:h-[600px] z-30'>
								<Image
									...
									loading='eager'
								/>
								<div className='absolute left-[37px] lg:left-[74px] top-[5px] lg:top-[10px] max-h-[277px] lg:max-h-[552px] overflow-scroll rounded-2xl lg:rounded-[27px]'>
									<div
										className={`relative w-[127px] h-[${
											 content.mobileImgHeight
										}px] lg:w-[254px] lg:h-[${
											 content.mobileImgHeightLg
										}px] rounded-2xl lg:rounded-[27px]`}
									>
										<Image
											src={ content.imageSrcMbl}
											layout='fill'
											// width={130}
											// height={500}
											alt={ content.name}
