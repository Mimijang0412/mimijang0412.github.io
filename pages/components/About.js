...
const About = () => {
	return (
		<div
			id='about' className='relative flex flex-col md:flex-row items-center justify-between py-10 md:py-20 px-6 mg:px-40 bg-white text-grey-800 dark:bg-black dark:text-white'
		>
			<div className='relative overflow-hidden shadow-white profile-img bg-red rounded-full m-4 md:m-12'>
				<Image
					src='/images/mimi.jpg' width='400' height='400' alt='mimi jang'
				/>
			</div>
			<div>
